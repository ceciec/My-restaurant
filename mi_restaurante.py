...
aplicacion.title("Mi Restaurante - Sistema de Facturacion J&C")
...
#etiqueta titulo
etiqueta_titulo = Label(panel_superior, text='Sistema de Facturacion', fg='LightYellow',
                        font=('Dosis', 40), bg= 'steel blue', width=27)
...
#panel costos
panel_costos = Frame(panel_izquierdo, bd=1, relief=SUNKEN, bg='light slate gray', padx=50)
panel_costos.pack(side=BOTTOM)

#panel comidas
panel_comidas = LabelFrame(panel_izquierdo, text='Comida', font=('Dosis', 19, 'bold'), 
                           bd=1, relief=SUNKEN, fg='light slate gray')
...
#panel calculadora
panel_calculadora = Frame(panel_derecha, bd=1, relief=SUNKEN, bg='white')
panel_calculadora.pack()

#panel recibo
panel_recibo = Frame(panel_derecha, bd=1, relief=SUNKEN, bg='SteelBlue4')
panel_recibo.pack()

#panel botones
panel_botones = Frame(panel_derecha, bd=1, relief=SUNKEN, bg='SteelBlue4')
panel_botones.pack()


#lista de productos
lista_comidas = ['pollo', 'chaufa', 'ceviche', 'pizza', 'ramen', 'caldo', 'alitas', 'chupe']
lista_bebidas = ['agua', 'coca', 'inka', 'Cusqueña', 'Pilsen', 'vino', 'limonada', 'chicha']
lista_postres = ['helado', 'gelatina', 'pastel', 'yogurt', 'galleta', 'flan', 'frutas', 'brownies']
